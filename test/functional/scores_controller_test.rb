...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { leaderboard_id: @score.leaderboard_id, player: @score.player, points: @score.points }
    end
  ...
  test "should update score" do
    put :update, id: @score, score: { leaderboard_id: @score.leaderboard_id, player: @score.player, points: @score.points }
    assert_redirected_to score_path(assigns(:score))
  end
